...
import { Vote, LogOut, User, Plus, Sun, Moon, Shield } from 'lucide-react';
import { useAuth } from '../../hooks/useAuth';
import { useTheme } from '../../contexts/ThemeContext';
import { Button } from '../ui/Button';

// Admin emails and UIDs who see the admin link
const ADMIN_EMAILS = ['tonyweeg@gmail.com'];
const ADMIN_UIDS = ['4LsDOrZa6JYWRvwh6umFNmuuaMz2'];
