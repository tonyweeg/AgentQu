...
const AuthScreen: React.FC<AuthScreenProps> = ({ onSuccess }) => {
  ...
  // Tree SVG component - region-specific shapes
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Nice Clouds (always visible, subtle) */}
        {showNiceClouds && (
          <>
            ...
            <svg className="absolute top-24 right-24 w-32 h-16 opacity-35 animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} viewBox="0 0 100 50">
              <ellipse cx="30" cy="35" rx="25" ry="14" fill="white"/>
              <ellipse cx="55" cy="32" rx="30" ry="17" fill="white"/>
            </svg>
            <svg className="absolute top-36 left-56 w-24 h-12 opacity-30 animate-pulse" style={{ animationDuration: '12s', animationDelay: '4s' }} viewBox="0 0 100 50">
        ...
        {/* More Clouds (cloudy/rainy weather - darker, more prominent) */}
        {showClouds && (
          <>
            <svg className="absolute top-12 left-24 w-36 h-18 opacity-70" viewBox="0 0 100 50">
            ...
            <svg className="absolute top-20 right-32 w-40 h-20 opacity-65" viewBox="0 0 100 50">
              <ellipse cx="25" cy="35" rx="25" ry="15" fill="#9ca3af"/>
